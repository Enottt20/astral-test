...
func (r *DocumentsPostgres) Create(ctx context.Context, token string, doc *domain.Document, jsonData string, fileData []byte) error {
...
func (r *DocumentsPostgres) GetAll(ctx context.Context, token, login, key, value string, limit int) ([]*domain.Document, error) {
...
func (r *DocumentsPostgres) GetByID(ctx context.Context, token, id string) (*domain.Document, []byte, error) {
	var hasAccess bool
	query := `SELECT EXISTS(
